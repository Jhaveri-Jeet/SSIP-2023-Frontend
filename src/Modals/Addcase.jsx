  ...
  if (editCaseData) {
    return (
      <>
        <div>
          <div
            className={`fixed z-50 left-0 top-0 flex h-screen w-full items-center justify-center bg-black bg-opacity-50 overflow-y-auto overflow-x-hidden ${isOpen ? "block" : "hidden"
              }`}
          >
